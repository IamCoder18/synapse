 ...
 * identical per style per scenario. The stimulus thread stamps
 * {@link LatencyProbe#stimulus} immediately before the write to the real stub
 * {@link Gamepad} volatile fields — that stamp is the "input" end of
 * input-to-actuation latency.
 */
